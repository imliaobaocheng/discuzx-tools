...
from discuzx_tools.conf.data_config import cache_option
from discuzx_tools.libs.common.common import ChinaProvider
from discuzx_tools.libs.register.control import SWITCH_ZH_CN
